...
class CardMovimentacoesItem extends StatelessWidget {
  ...
  _dialogConfimacao(BuildContext context, double width){
    showDialog(
      ...
      builder: (context){
        return AlertDialog(
          title: Text("Remover Movimientos",textAlign: TextAlign.start,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.lightBlue[700]),),
          ...
          content: SingleChildScrollView(
            ...
            children: <Widget>[
              ...
              Text("S/ ${mov.valor}",style: TextStyle(fontWeight: FontWeight.bold,color: mov.tipo.toString() =="r" ?Colors.green[600] : Colors.red[600])),
